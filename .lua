...
if not isfile("demose.fein") then
   makefolder("demose.fein")
end
...
local library = {
   Title = 'demose.fein | <font color="rgb(189, 172, 255)">fallen</font>',
   AnimatedText = false,
...
ScreenGui.Name = "velocity_menu" --// not my ui!!
menu.bg.pre.Text = ""

task.spawn(function()
   local textList = { 
       '', 'd', 'de', 'dem', 'demo', 'demos', 'demose', 'FEIN.', 'demose.<font color="rgb(189, 172, 255)">f</font>',
       'demose.<font color="rgb(189, 172, 255)">fe</font>', 'demose.<font color="rgb(189, 172, 255)">fein</font>',
       'demose.<font color="rgb(189, 172, 255)">fein</font> |', 'demose.<font color="rgb(189, 172, 255)">fein</font> | u',
       'demose.<font color="rgb(189, 172, 255)">fein</font> | un', 'demose.<font color="rgb(189, 172, 255)">fein</font> | uni',
       'demose.<font color="rgb(189, 172, 255)">fein</font> | univ', 'demose.<font color="rgb(189, 172, 255)">fein</font> | univers',
       'demose.<font color="rgb(189, 172, 255)">fein</font> | universa', 'demose.<font color="rgb(189, 172, 255)">fein</font> | universal',
       'demose.<font color="rgb(189, 172, 255)">fein</font> | universa', 'demose.<font color="rgb(189, 172, 255)">fein</font> | univers',
       'demose.<font color="rgb(189, 172, 255)">fein</font> | univer', 'demose.<font color="rgb(189, 172, 255)">fein</font> | unive',
       'demose.<font color="rgb(189, 172, 255)">fein</font> | univ', 'demose.<font color="rgb(189, 172, 255)">fein</font> | uni',
       'demose.<font color="rgb(189, 172, 255)">fein</font> | un', 'demose.<font color="rgb(189, 172, 255)">fein</font> | u',
       'demose.<font color="rgb(189, 172, 255)">fein</font> |', 'demose.<font color="rgb(189, 172, 255)">fein</font>',
       'demose.<font color="rgb(189, 172, 255)">fe</font>', 'demose.<font color="rgb(189, 172, 255)">f</font>',
       'demose.', 'demose', 'demos', 'demo', 'dem', 'de', 'd', 'FEIN'
   }
   while wait(0.5) do
       if library.AnimatedText then
           ...
           menu.bg.pre.Text = 'demose.fein | <font color="rgb(189, 172, 255)">fallen</font>'
       end
   end
end)  
                        ...
                        function library:addTab(name,image)
                           ...
                           function contains(list, x)
                              for _, v in pairs(list) do
                                 ...
                                 writefile("demose.fein/"..name..".cfg",game:GetService("HttpService"):JSONEncode(jig))
                              ...
                              function library:deleteConfig()
                                 ...
                                 function library:refreshConfigs()
                                    local tbl = {}
                                    for i,v in next, listfiles("demose.fein") do table.insert(tbl,v) end
